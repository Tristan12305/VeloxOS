 ...
 * font.h
 *
 * 8x16 bitmap font covering the first 128 ASCII glyphs.
 * Each glyph is 16 bytes; each byte is one row of 8 pixels,
 * MSB = leftmost pixel.
 *
 * Derived from the classic IBM VGA 8x16 / CP437 bitmaps which are
...
/* font_bitmap[c] is the 16-byte bitmap for ASCII character c. */
static const uint8_t font_bitmap[FONT_GLYPHS][FONT_HEIGHT] = {
    ...
    /* 0x03 ETX */ {0x00,0x00,0x00,0x6C,0xFE,0xFE,0xFE,0xFE,0x7C,0x38,0x10,0x00,0x00,0x00,0x00,0x00},
    /* 0x04 EOT */ {0x00,0x00,0x00,0x10,0x38,0x7C,0xFE,0x7C,0x38,0x10,0x00,0x00,0x00,0x00,0x00,0x00},
    ...
    /* 0x1D GS  */ {0x00,0x00,0x00,0x00,0x00,0x28,0x6C,0xFE,0x6C,0x28,0x00,0x00,0x00,0x00,0x00,0x00},
    ...
    /* 0x20 SPC */ {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
